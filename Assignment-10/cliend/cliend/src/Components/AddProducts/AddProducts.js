...
const AddProducts = () => {
 ...
 const handleSubmit=(e)=>{
     e.preventDefault(e)
     fetch('https://limitless-badlands-88219.herokuapp.com/addProduct', {
            method: 'POST',
      ...
      <div className="row justify-content-center">
        <div className="col-lg-6">
          <form className="mb-3"onSubmit={handleSubmit} >
            ...
            <input className="form-control mb-3"  onBlur={handleBlur}type="price" name="Price" placeholder="Price" required/>
            <input className="form-control mb-3"  onBlur={handleBlur}type="text" name="img" placeholder="img URL" required />
